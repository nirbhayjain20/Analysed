                                ...
                                <div class="row-recruiter inputs-for-add-client-below-image-box">
                                    <p class="select-for-select-image-box-below-inputs right-side"> 
                                        <label for="default-select-for-no.3">Package type *</label>
                                            <select name="Package type"id="default-select-for-no.3" class="default-select-for-add-client-1">
                                    ...
                                    <p class="select-for-select-image-box-below-inputs"> 
                                        <label for="default-select-for-no.4">Package type *</label>
                                            <select name="Package type" id="default-select-for-no.4" class="default-select-for-add-client-1">
                                    ...
                                    <p class="input-para-add-client-ekam-1"> 
                                        <label for="default-select-for-no.9">Package *</label>
                                            <input id="default-select-for-no.9" name="Package" class="default-input-for-add-client-1"placeholder="Your designation">
                                    </p>
                                    <p class="input-para-add-client-ekam-1"> 
                                        <label for="default-select-for-no.9">Bill rate *</label>
                                            <input id="default-select-for-no.9" name="Bill rate" class="default-input-for-add-client-1"placeholder="Your designation">
                                    </p>
                                    <p class="input-para-add-client-ekam-1"> 
                                        <label for="default-select-for-no.9">Markup % *</label>
                                            <input id="default-select-for-no.9" name="Markup" class="default-input-for-add-client-1"placeholder="Your designation">
                                    </p>
                                    <p class="input-para-add-client-ekam-1"> 
                                        <label for="default-select-for-no.9">Client margin *</label>
                                            <input id="default-select-for-no.9" name="Client margin" class="default-input-for-add-client-1"placeholder="Your designation">
                                    </p>
                                    <p class="input-para-add-client-ekam-1 fx-city-name-1"> 
                                        <label for="default-select-for-no.9">Days on</label>
                                            <input id="default-select-for-no.9" name="Days on" class="default-input-for-add-client-1"placeholder="Your designation">
                                    </p>
                                    <p class="input-para-add-client-ekam-1 fx-city-name-1"> 
                                        <label for="default-select-for-no.9">Days off</label>
                                            <input id="default-select-for-no.9" name="Days off" class="default-input-for-add-client-1"placeholder="Your designation">
                                    </p>
                                    <p class="input-para-add-client-ekam-1 fx-city-name-1"> 
                                        <label for="default-select-for-no.9">Shift pattern</label>
                                            <input id="default-select-for-no.9" name="Shift pattern" class="default-input-for-add-client-1"placeholder="Your designation">
                                    </p>
